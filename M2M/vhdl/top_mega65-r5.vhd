...
architecture synthesis of mega65_r5 is
   ...
   signal main_eth_rx_cnt_drop   : std_logic_vector(15 downto 0); -- Number of Rx frames dropped (e.g. FIFO overrun or bad CRC)
...
begin
   ...
   -- stay tied inactive (read-only milestone).
   f_motorb_o            <= '1';
   f_selectb_o           <= '1';
   f_wdata_o             <= '1';
   f_wgate_o             <= '1';
   ...
   port map (
      ...
      main_eth_rx_cnt_drop_o  => main_eth_rx_cnt_drop,
   ...
   CORE : entity work.MEGA65_Core
      ...
      port map (
         ...
         -- Physical internal 1581 (issue #90): board floppy pins
         f_rdata_i               => f_rdata_i,
         f_index_i               => f_index_i,
         ...
         eth_rx_cnt_drop_i       => main_eth_rx_cnt_drop
      ); -- CORE
