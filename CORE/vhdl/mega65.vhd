...
begin
   ...
   hr_core_speed_proc : process (hr_clk_i)
   begin
   ...
   end process hr_core_speed_proc;
   ...
   main_inst : entity work.main
      ...
      port map (
         ...
         -- video_retro15kHz_i: Analog video output configuration:
         -- Horizontal sync frequency: '0'  =30 kHz ("normal" on "modern" analog monitors), '1'=retro 15 kHz
         c64_ntsc_i             => c64_ntsc,
   ...
   avm_fifo_main2hr_inst : entity work.avm_fifo
      generic map (
         G_WR_DEPTH     => 16,
         G_RD_DEPTH     => 16,
         G_FILL_SIZE    => 1,
