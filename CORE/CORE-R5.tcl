...
# be fully up-to-date.
# The project file CORE-R5.xpr is the "master" file.
...
cd ..
synth_design -top mega65_r5 -flatten_hierarchy none
source debug.tcl
opt_design
place_design
phys_opt_design
route_design
write_checkpoint -force mega65_r5.dcp
write_bitstream -force mega65_r5.bit
exit
