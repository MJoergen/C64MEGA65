...
# be fully up-to-date.
# The project file CORE-R3.xpr is the "master" file.
...
read_vhdl -vhdl2008 { \
      ...
      ../M2M/vhdl/controllers/M65/pcm_to_pdm.vhdl \
...
cd ..
synth_design -top mega65_r3 -flatten_hierarchy none
source debug.tcl
opt_design
place_design
phys_opt_design
route_design
write_checkpoint -force mega65_r3.dcp
write_bitstream -force mega65_r3.bit
exit
