...
| 7      | DMA support for hardware cartridges                        | Full DMA support for hardware cartridges such as hardware REUs (for example REU Grande), Sidekick64, TeensyROM and more.                                                                                                                                               | no       | no     | yes  | yes  |
