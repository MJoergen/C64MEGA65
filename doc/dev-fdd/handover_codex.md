...
> `doc/dev-fdd/`. Feature-branch statements below describe historical
> checkpoints; physical write support remains a separate, unauthorized
> milestone.
...
through `doc/dev-fdd/rom_emu/run_proofs.py`. All proofs pass. The important
ROM facts are:
...
`doc/dev-fdd/f011_reference_notes.md`. Do not edit that file. Its most
...
`doc/dev-fdd/f011_reference_notes.md` to remove the inherited errors. It
...
file completely, `doc/dev-fdd/plan_codex.md` completely, and Fable-owned
`doc/dev-fdd/f011_reference_notes.md` completely. Preserve the Fable file
